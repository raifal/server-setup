...
sudo docker build --build-arg apache_httpd_passwd_user2=${apache_httpd_passwd_user2} --build-arg apache_httpd_passwd_password2=${apache_httpd_passwd_password2} --build-arg apache_httpd_passwd_user=${apache_httpd_passwd_user} --build-arg apache_httpd_passwd_password=${apache_httpd_passwd_password} --build-arg arduino_interface_passwd_user=${arduino_interface_passwd_user} --build-arg arduino_interface_passwd_password=${arduino_interface_passwd_password} -t rf_apache_httpd  apache_httpd/.

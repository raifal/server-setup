...
sudo docker cp temp-ssl:/etc/ssl/private/ss_server.key ./ssl_generated/.
sudo docker cp temp-ssl:/etc/ssl/certs/ss_server.crt ./ssl_generated/.
sudo docker cp temp-ssl:/hsm.keystore ./ssl_generated/.
